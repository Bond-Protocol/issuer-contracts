...
///      contract. A reason to use this callback would be if you wanted to create a
///      to avoid approving the Bond contract to spend your payout tokens from a wallet
///      or multi-sig.
///
